...
[^8]: https://sbiferi.co.jp/assets/pdf/review/review_vol08_03_202508.pdf （※ファクトチェック注: 同URLはウェブ検索で確認不可。SBI Research Review vol.8の他の号（05, 08等）は確認済みだが、03号は未インデックスまたはPerplexityによるURL捏造の可能性あり）
